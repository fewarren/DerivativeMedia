...
class ViewerDetector extends AbstractHelper
{
    ...
    /**
     * Initializes the ViewerDetector helper with the provided ViewerDetectorService.
     *
     * @param ViewerDetectorService $viewerDetector The service used for viewer detection and video URL generation.
     */
    ...
    /**
     * Returns the ViewerDetector view helper instance for method chaining or direct access.
     *
     * @return self The current ViewerDetector helper instance.
     */
    ...
    /**
     * Generates the optimal video URL for the given media and site slug, selecting the best viewer strategy.
     *
     ...
     *
     * @return array|null The best video viewer information, or null if no suitable viewer is found.
     */
